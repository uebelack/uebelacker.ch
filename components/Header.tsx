  ...
  return (
    <header>
      ...
      <div className="fixed bottom-0 m-5">
        <div className="pb-2"><a href="https://github.com/hackercowboy"><FaGithub size="2.5em" /></a></div>
        <a className="pb-10" href="https://www.linkedin.com/in/daviduebelacker/"><FaLinkedin size="2.5em" /></a>
      </div>
    </header>
  );
}
